...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("editor/AssetsBrowser.xml", __ASSET__editor_assetsbrowser_xml);
		type.set ("editor/AssetsBrowser.xml", AssetType.TEXT);
		className.set ("editor/icons/delete.png", __ASSET__editor_icons_delete_png);
		type.set ("editor/icons/delete.png", AssetType.IMAGE);
		className.set ("editor/icons/file-new.png", __ASSET__editor_icons_file_new_png);
		type.set ("editor/icons/file-new.png", AssetType.IMAGE);
		className.set ("editor/icons/file.png", __ASSET__editor_icons_file_png);
		type.set ("editor/icons/file.png", AssetType.IMAGE);
		className.set ("editor/icons/folder-new.png", __ASSET__editor_icons_folder_new_png);
		type.set ("editor/icons/folder-new.png", AssetType.IMAGE);
		className.set ("editor/icons/folder.png", __ASSET__editor_icons_folder_png);
		type.set ("editor/icons/folder.png", AssetType.IMAGE);
		className.set ("editor/icons/refresh.png", __ASSET__editor_icons_refresh_png);
		type.set ("editor/icons/refresh.png", AssetType.IMAGE);
		className.set ("editor/main.xml", __ASSET__editor_main_xml);
		...
		type.set (id, AssetType.FONT);
		id = "editor/AssetsBrowser.xml";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "editor/icons/delete.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "editor/icons/file-new.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "editor/icons/file.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "editor/icons/folder-new.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "editor/icons/folder.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "editor/icons/refresh.png";
		path.set (id, id);
...
@:keep class __ASSET__editor_assetsbrowser_xml extends openfl.utils.ByteArray { }
@:keep class __ASSET__editor_icons_delete_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__editor_icons_file_new_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__editor_icons_file_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__editor_icons_folder_new_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__editor_icons_folder_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__editor_icons_refresh_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__editor_main_xml extends openfl.utils.ByteArray { }
...
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/default/circle.png") class __ASSET__styles_default_circle_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/default/collapse.png") class __ASSET__styles_default_collapse_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/default/cross.png") class __ASSET__styles_default_cross_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/default/expand.png") class __ASSET__styles_default_expand_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/default/up_down.png") class __ASSET__styles_default_up_down_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_down.png") class __ASSET__styles_gradient_arrow_down_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_down_dark.png") class __ASSET__styles_gradient_arrow_down_dark_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_down_disabled.png") class __ASSET__styles_gradient_arrow_down_disabled_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_left.png") class __ASSET__styles_gradient_arrow_left_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_left_disabled.png") class __ASSET__styles_gradient_arrow_left_disabled_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_right.png") class __ASSET__styles_gradient_arrow_right_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_right2.png") class __ASSET__styles_gradient_arrow_right2_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_right_dark.png") class __ASSET__styles_gradient_arrow_right_dark_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_right_disabled.png") class __ASSET__styles_gradient_arrow_right_disabled_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_up.png") class __ASSET__styles_gradient_arrow_up_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/arrow_up_disabled.png") class __ASSET__styles_gradient_arrow_up_disabled_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/circle_dark.png") class __ASSET__styles_gradient_circle_dark_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/cross_dark.png") class __ASSET__styles_gradient_cross_dark_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/cross_dark_disabled.png") class __ASSET__styles_gradient_cross_dark_disabled_png extends flash.display.BitmapData {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/gradient.css") class __ASSET__styles_gradient_gradient_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/gradient.min.css") class __ASSET__styles_gradient_gradient_min_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/gradient_mobile.css") class __ASSET__styles_gradient_gradient_mobile_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/gradient_mobile.min.css") class __ASSET__styles_gradient_gradient_mobile_min_css extends flash.utils.ByteArray {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/gripper_horizontal.png") class __ASSET__styles_gradient_gripper_horizontal_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/gripper_horizontal_disabled.png") class __ASSET__styles_gradient_gripper_horizontal_disabled_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/gripper_vertical.png") class __ASSET__styles_gradient_gripper_vertical_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/gradient/gripper_vertical_disabled.png") class __ASSET__styles_gradient_gripper_vertical_disabled_png extends flash.display.BitmapData {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/accordion.css") class __ASSET__styles_windows_accordion_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/accordion.min.css") class __ASSET__styles_windows_accordion_min_css extends flash.utils.ByteArray {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/button.png") class __ASSET__styles_windows_button_png extends flash.display.BitmapData {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/buttons.css") class __ASSET__styles_windows_buttons_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/buttons.min.css") class __ASSET__styles_windows_buttons_min_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/calendar.css") class __ASSET__styles_windows_calendar_css extends flash.utils.ByteArray {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/checkbox.png") class __ASSET__styles_windows_checkbox_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/container.png") class __ASSET__styles_windows_container_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/down_arrow.png") class __ASSET__styles_windows_glyphs_down_arrow_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/hscroll_thumb_gripper_down.png") class __ASSET__styles_windows_glyphs_hscroll_thumb_gripper_down_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/hscroll_thumb_gripper_over.png") class __ASSET__styles_windows_glyphs_hscroll_thumb_gripper_over_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/hscroll_thumb_gripper_up.png") class __ASSET__styles_windows_glyphs_hscroll_thumb_gripper_up_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/left_arrow.png") class __ASSET__styles_windows_glyphs_left_arrow_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/right_arrow.png") class __ASSET__styles_windows_glyphs_right_arrow_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/up_arrow.png") class __ASSET__styles_windows_glyphs_up_arrow_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/vscroll_thumb_gripper_down.png") class __ASSET__styles_windows_glyphs_vscroll_thumb_gripper_down_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/vscroll_thumb_gripper_over.png") class __ASSET__styles_windows_glyphs_vscroll_thumb_gripper_over_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/glyphs/vscroll_thumb_gripper_up.png") class __ASSET__styles_windows_glyphs_vscroll_thumb_gripper_up_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/hprogress.png") class __ASSET__styles_windows_hprogress_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/hscroll.png") class __ASSET__styles_windows_hscroll_png extends flash.display.BitmapData {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/listview.css") class __ASSET__styles_windows_listview_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/listview.min.css") class __ASSET__styles_windows_listview_min_css extends flash.utils.ByteArray {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/listview.png") class __ASSET__styles_windows_listview_png extends flash.display.BitmapData {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/menus.css") class __ASSET__styles_windows_menus_css extends flash.utils.ByteArray {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/optionbox.png") class __ASSET__styles_windows_optionbox_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/popup.png") class __ASSET__styles_windows_popup_png extends flash.display.BitmapData {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/popups.css") class __ASSET__styles_windows_popups_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/rtf.css") class __ASSET__styles_windows_rtf_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/scrolls.css") class __ASSET__styles_windows_scrolls_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/scrolls.min.css") class __ASSET__styles_windows_scrolls_min_css extends flash.utils.ByteArray {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/sliders.css") class __ASSET__styles_windows_sliders_css extends flash.utils.ByteArray {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/tab.png") class __ASSET__styles_windows_tab_png extends flash.display.BitmapData {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/tabs.css") class __ASSET__styles_windows_tabs_css extends flash.utils.ByteArray {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/textinput.png") class __ASSET__styles_windows_textinput_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/vprogress.png") class __ASSET__styles_windows_vprogress_png extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/vscroll.png") class __ASSET__styles_windows_vscroll_png extends flash.display.BitmapData {}
@:file("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/styles/windows/windows.css") class __ASSET__styles_windows_windows_css extends flash.utils.ByteArray {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/img/slinky_small.jpg") class __ASSET__img_slinky_small_jpg extends flash.display.BitmapData {}
@:bitmap("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/img/slinky_tiny.jpg") class __ASSET__img_slinky_tiny_jpg extends flash.display.BitmapData {}
@:font("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/fonts/Oxygen-Bold.ttf") class __ASSET__fonts_oxygen_bold_ttf extends flash.text.Font {}
@:font("C:/outils/HaxeToolkit/haxe/lib/haxeui/1,4,14/fonts/Oxygen.ttf") class __ASSET__fonts_oxygen_ttf extends flash.text.Font {}
@:file("C:/workspace/haxelib-dev/RadEngine/assets/editor/AssetsBrowser.xml") class __ASSET__editor_assetsbrowser_xml extends flash.utils.ByteArray {}
@:bitmap("C:/workspace/haxelib-dev/RadEngine/assets/editor/icons/delete.png") class __ASSET__editor_icons_delete_png extends flash.display.BitmapData {}
@:bitmap("C:/workspace/haxelib-dev/RadEngine/assets/editor/icons/file-new.png") class __ASSET__editor_icons_file_new_png extends flash.display.BitmapData {}
@:bitmap("C:/workspace/haxelib-dev/RadEngine/assets/editor/icons/file.png") class __ASSET__editor_icons_file_png extends flash.display.BitmapData {}
@:bitmap("C:/workspace/haxelib-dev/RadEngine/assets/editor/icons/folder-new.png") class __ASSET__editor_icons_folder_new_png extends flash.display.BitmapData {}
@:bitmap("C:/workspace/haxelib-dev/RadEngine/assets/editor/icons/folder.png") class __ASSET__editor_icons_folder_png extends flash.display.BitmapData {}
@:bitmap("C:/workspace/haxelib-dev/RadEngine/assets/editor/icons/refresh.png") class __ASSET__editor_icons_refresh_png extends flash.display.BitmapData {}
@:file("C:/workspace/haxelib-dev/RadEngine/assets/editor/main.xml") class __ASSET__editor_main_xml extends flash.utils.ByteArray {}
